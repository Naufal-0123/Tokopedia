            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("asset/image/parfum.png"),
                      fit: BoxFit.cover),
                ),
              ),
              SizedBox(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Image.asset('asset/image/parfum2.png'),
                        SizedBox(
                          width: lebar * 0.015,
                        ),
                        Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Image.asset('asset/image/ceklis.png',
                                    width: 18),
                                Text(
                                  ' Mine. Parfumery',
                                  style: TextStyle(
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    review('asset/image/review.png', ''),
                    review('asset/image/review2.png', ''),
                    review('asset/image/review3.png', ''),
                    review('asset/image/review4.png', ''),
                    review('asset/image/review5.png', '+61'),
                  ],
                ),
              ),
              SizedBox(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset('asset/image/orang.png'),
                    ),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Image.asset('asset/image/orang2.png'),
                    Container(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Row(
                      children: [
                        Image.asset('asset/image/penjual.png'),
                        Container(
                            width: 60,
                            height: 25,
